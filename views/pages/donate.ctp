...
<div id="donatePage" class="leftSideSmall right">
	...
	<div id="donateTable">
		<div class="right" id="donateTableRight">
			...
			<div class="donateBox" style="height:155px !important;">
		...
		ניתן לתרום לוועד באמצעות הוראת קבע
<br />אותה עלייך לפתוח בסניף הבנק שלך.
התרומה תבוצע על סכום קבוע ובאופן עוקב אוטומטית.
<br />
<br />בנק הפועלים, סניף 772, חשבון 388482
ניתן לבטל באופן עצמאי את הוראת הקבע בכל עת.	
				</div>
			</div>
			<div class="donateBox">
